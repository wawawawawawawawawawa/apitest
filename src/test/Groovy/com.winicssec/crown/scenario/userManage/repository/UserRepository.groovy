...
import com.winicssec.crown.util.CrownDataSource
...
class UserRepository extends CrownDataSource{
    ...
    def insertSysUserTable(loginName, nickName, password, email, phone, status){
        def insertUserSql = "insert into sys_user(loginName, nickName,password,email,phone,status,create_uid,create_time,update_time) values (?,?,?,?,?,?,1,'2019-07-01 10:00:00','2019-07-01 10:00:00)"
